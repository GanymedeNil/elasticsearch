<p align="center">
<a href="https://travis-ci.org/GanymedeNil/elasticsearch"><img src="https://travis-ci.org/GanymedeNil/elasticsearch.svg?branch=master" alt="Build Status"></a>
<a href="https://packagist.org/packages/GanymedeNil/elasticsearch"><img src="https://poser.pugx.org/GanymedeNil/elasticsearch/v/stable.svg" alt="Latest Stable Version"></a>
<a href="https://packagist.org/packages/GanymedeNil/elasticsearch"><img src="https://poser.pugx.org/GanymedeNil/elasticsearch/d/total.svg" alt="Total Downloads"></a>
<a href="https://packagist.org/packages/GanymedeNil/elasticsearch"><img src="https://poser.pugx.org/GanymedeNil/elasticsearch/license.svg" alt="License"></a>
</p>

<p align="center"><img src="http://GanymedeNil.com/images/GanymedeNil-elasticsearch.png?123"></p>
...
- `php` >= 5.6.6 
  ...
  See [Travis CI Builds](https://travis-ci.org/GanymedeNil/elasticsearch).
...
See [Full Documentation](https://github.com/GanymedeNil/elasticsearch/wiki/1.-Installation).
...
```bash
$ composer require GanymedeNil/elasticsearch
```

##### 2) Add package service provider (< laravel 5.5).

```php
GanymedeNil\Elasticsearch\ElasticsearchServiceProvider::class
```

##### 3) Add package alias (< laravel 5.5).

```php
'ES' => GanymedeNil\Elasticsearch\Facades\ES::class
```
	
##### 4) Publishing.

```bash
$ php artisan vendor:publish --provider="GanymedeNil\Elasticsearch\ElasticsearchServiceProvider"
```
...
```php
$app->register(GanymedeNil\Elasticsearch\ElasticsearchServiceProvider::class);
```
	
##### 3) Copy package config directory `vendor/GanymedeNil/elasticsearch/src/config` to root folder alongside with `app` directory.
...
use GanymedeNil\Elasticsearch\Connection;
...
use GanymedeNil\Elasticsearch\Model;
...
class Post extends Model
{
     ...
     *
     * @param \GanymedeNil\Elasticsearch\Query $query
     * @return \GanymedeNil\Elasticsearch\Query
     */
...
## Releases
  ...
  See [Change Log](https://github.com/GanymedeNil/elasticsearch/blob/master/CHANGELOG.md).

## Author
[Basem Khirat](http://GanymedeNil.com) - [GanymedeNil@gmail.com](mailto:GanymedeNil@gmail.com) - [@GanymedeNil](https://twitter.com/GanymedeNil)  


## Bugs, Suggestions and Contributions

Thanks to [everyone](https://github.com/GanymedeNil/elasticsearch/graphs/contributors)
who has contributed to this project!

Please use [Github](https://github.com/GanymedeNil/elasticsearch) for reporting bugs, 
